...
class MyDocument extends Document {
  render() {
    return (
      ...
      'https://ss.poochie.co/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      })(window,document,'script','dataLayer',${process.env.GTM_ID_WEB});`,
            }}
          />
        ...
        <body className="loading">
          ...
          <noscript
            dangerouslySetInnerHTML={{
              __html: `<iframe src="https://ss.poochie.co/ns.html?id=${process.env.GTM_ID_WEB}" height="0" width="0" style="display: none; visibility: hidden;" />`,
            }}
          />
        </body>
      </Html>
