  ...
  return (
    <Container className="pt-16 pb-8">
      ...
      <p>
        ...
        created with the help of the Privacy Policy Generator. Interpretation
        ...
        this Privacy Policy: Account means a unique account created for You to
        ...
        Company", "We", "Us" or "Our" in this Agreement) refers to POOCHIE LLC,
        5940 S Rainbow Blvd Ste 400 Las Vegas, Nevada. Cookies are small files
        ...
        among its many uses. Country refers to: California, United States Device
        ...
        visit). Website refers to POOCHIE, accessible from
        ...
        through a mobile device. Tracking Technologies and Cookies We use
        ...
        on the Privacy Policies website article. We use both Session and
        Persistent Cookies for the purposes set out below: Necessary / Essential
        Cookies Type: Session Cookies Administered by: Us Purpose: These Cookies
        are essential to provide You with services available through the Website
        and to enable You to use some of its features. They help to authenticate
        ...
        Policy. Use of Your Personal Data The Company may use Personal Data for
        the following purposes: To provide and maintain our Service, including
        to monitor the usage of our Service. To manage Your Account: to manage
