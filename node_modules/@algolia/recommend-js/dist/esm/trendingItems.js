...
function useTrendingItems(props) {
  ...
  useEffect(function () {
    setStatus('loading');
    getTrendingItems(props).then(function (response) {
      setResult(response);
      setStatus('idle');
    });
  }, [props, setStatus]);
...
function TrendingItems(props) {
  ...
  return h(UncontrolledTrendingItems, _extends({}, props, {
...
export function trendingItems(_ref) {
  ...
  var vnode = h(TrendingItems, _extends({}, props, {
